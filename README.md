...
Cloudflare Worker with Durable Object support, served at `erd.mmec.ca/gm5/`.
...
`wss://erd.mmec.ca/gm5/api/signal/ws?peerId=<id>[&room=<code>]`
...
- The current version is declared as `const VERSION` near the top of `gm5/game.js` and displayed in the top-left of the lobby.
